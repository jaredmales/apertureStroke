...
are rerun under the new output root with cutoffs
`0,5,10,20,40,60,80,100`. Their existing Zernike theory products are also
generated in the new output tree. No 25.4 m Zernike theory is generated by
this script because it would not describe the hybrid basis.
